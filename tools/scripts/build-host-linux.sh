...
#
# Output: runtime/wandr-host/target/x86_64-unknown-linux-gnu/release/wasm-android-host
set -euo pipefail
...
OUT="$REPO_ROOT/runtime/wandr-host/target/$TARGET/release/wasm-android-host"
