...
HOST_OUT="$REPO_ROOT/runtime/wart-host/target/aarch64-linux-android/release/wasm-android-host"
...
cd "$REPO_ROOT/runtime/wart-arbiter"
echo "Building wart-arbiter for aarch64-linux-android …"
cargo build --target aarch64-linux-android --release

ARB_OUT="$REPO_ROOT/runtime/wart-arbiter/target/aarch64-linux-android/release/wart-arbiter"
