// Second cross-app dep demo (task 40). Calls `war:emoji/picker.list-all`
// via the new generic wart-host dep wiring (task 39), renders the
// result as a category-grouped grid of emojis.
//
// Side-purpose: visual proof that wart-host's `wire_dep_into_linker`
// works for arbitrary system components, not just markdown. The
// markdown_bindings module + per-dep match arm in wart-host are gone
