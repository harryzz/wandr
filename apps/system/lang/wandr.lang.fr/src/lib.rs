...
//!
//! Exports `wandr:keyboard-lang/lang` — returns the standard AZERTY
...
//!
//! Second concrete plugin alongside `wandr.lang.bg/`. Proves the
...
use exports::wandr::keyboard_lang_fr::lang::{Guest, Info, KeyDef, LayoutVariant};
