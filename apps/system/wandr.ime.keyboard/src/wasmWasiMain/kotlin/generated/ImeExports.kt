// wandr:ime/ime exports — task 49 step 1b. Hand-written @WasmExport wrappers
...
//
// The host (wandr-host) sends `editor-attached <input-type> <hint>
// <initial-text> <sel-start> <sel-end>` over `/data/local/tmp/
// wandr-host-<ime-pid>.sock` (task 49 step 1a), the inbound drain
...
/// Mirror of `wandr:ime/types.input-type`. Kotlin-side enum we hand into
...
@WasmExport("wandr:ime/ime@0.1.0#on-editor-attached")
...
@WasmExport("wandr:ime/ime@0.1.0#on-editor-detached")
