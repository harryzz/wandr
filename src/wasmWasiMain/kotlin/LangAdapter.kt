...
// `war.lang.*` plugin's exported `lang.get-info` + `lang.get-layout`
...
// `wart-app/src/wasmWasiMain/kotlin/EmojiImports.kt` /
...
// (`war:keyboard-lang-bg`, `war:keyboard-lang-fr`) because two
...
// a `package war:keyboard-lang-<id>` WIT, add an `import` line in
// `wit/war-ime-keyboard.wit`, and append a `Loader` entry here.
//
...
@WasmImport("war:keyboard-lang-bg/lang@0.1.0", "get-info")
private external fun __bg_get_info(retArea: Int)
@WasmImport("war:keyboard-lang-bg/lang@0.1.0", "get-layout")
private external fun __bg_get_layout(shifted: Int, retArea: Int)

@WasmImport("war:keyboard-lang-fr/lang@0.1.0", "get-info")
private external fun __fr_get_info(retArea: Int)
@WasmImport("war:keyboard-lang-fr/lang@0.1.0", "get-layout")
