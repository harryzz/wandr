...
extern void __component_type_object_force_link_cwandr_exports(void);
__attribute__((used))
void __component_type_object_force_link_cwandr_exports_public_use_in_this_compilation_unit(void) {
  __component_type_object_force_link_cwandr_exports();
}
