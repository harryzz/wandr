...
//!
//! The reference contract is `crates/wandr-call/proto/signal_signaling.proto`. We
...
//! suite  = AEAD AES-256-GCM   (NOT the AES128_CM_HMAC_SHA1_80 wandr-call hardcodes)
//! ```
//!
...
//! from the Signal engine's `IdentityKeyPair`, `apps/user/wandr.signal/engine/src/
...
/// which wandr-call does not yet act on).
#[cfg(feature = "signal")]
