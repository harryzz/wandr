// wandr-hal-net build.rs — codegen a minimal `android.net.IDnsResolver` client
...
// (the wandr-hal-display "mutate in OUT_DIR, never the submodule" pattern).
...
fn main() {
    ...
    let src = PathBuf::from("../wandr-host/vendor/aosp-packages-modules-dnsresolver/binder");
    ...
    std::fs::write(
        ...
        r#"// Trimmed by wandr-hal-net build.rs — see build.rs header. Method ORDER is
...
"#,
    ...
    let conn = PathBuf::from(
        "../wandr-host/vendor/aosp-packages-modules-connectivity/staticlibs/netd/binder",
    );
    ...
    // aidl-stubs.
    let sup = PathBuf::from("../wandr-host/vendor/aosp-hardware-interfaces/wifi/supplicant/aidl");
    let wifi_common = PathBuf::from("../wandr-host/vendor/aosp-hardware-interfaces/wifi/common/aidl");
    let stubs = PathBuf::from("../wandr-host/vendor/aidl-stubs");
    ...
    let wifi = PathBuf::from("../wandr-host/vendor/aosp-hardware-interfaces/wifi/aidl");
