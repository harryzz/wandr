...
mod tests {
    ...
    fn round_trip_read_only() {
        let fd = memfd("wart-bsm-ro", b"hello, world!");
    ...
    fn round_trip_writeable() {
        ...
        payload[0] = 1;
        payload[255] = 255;
        let fd = memfd("wart-bsm-rw", &payload);
    ...
    fn as_mut_slice_is_none_for_read_only() {
        let fd = memfd("wart-bsm-romut", b"abc");
    ...
    fn rejects_negative_offset() {
        let fd = memfd("wart-bsm-neg-off", b"abc");
    ...
    fn rejects_negative_size() {
        let fd = memfd("wart-bsm-neg-size", b"abc");
    ...
    fn page_aligned_offset_window() {
        ...
        payload[page]     = 0x42;
        payload[page + 7] = 0x37;
        let fd = memfd("wart-bsm-off", &payload);
