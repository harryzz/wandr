// wandr-hal-lights build.rs — codegen android.hardware.light.ILights (+ its
...
// codegens (wandr-host/build.rs), pointed at the vendored hardware-interfaces tree.
...
fn main() {
    ...
    let light_aidl =
        PathBuf::from("../wandr-host/vendor/aosp-hardware-interfaces/light/aidl");
    if !light_aidl.exists() {
        panic!("wandr-hal-lights: AIDL source missing: {}", light_aidl.display());
    }
