//! wart-arbiter-sensors — the SensorService role (Arbiter Inc., task 77).
//!
...
//! `wart-hal-sensors`; this module is desktop-testable via the `report-sensor`
//! sim verb (mirrors `report-orientation`) with no device.

use std::collections::HashMap;
use wart_arbiter_core::{ArbiterModule, Ctx, Effect, Event, Reply, SensorKind, SensorSlot};
...
mod tests {
    use super::*;
    use wart_arbiter_core::{Registry, Store};
