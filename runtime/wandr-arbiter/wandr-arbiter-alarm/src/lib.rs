//! wandr-arbiter-alarm — the AlarmManager/JobScheduler module (Arbiter Inc. 3c).
//!
//! Owns the timed-wake policy. Guests schedule via the `wandr:alarm/scheduler` host
...
use wandr_arbiter_core::{Alarm, ArbiterModule, Ctx, Effect, Event, LaunchKind, Reply};
