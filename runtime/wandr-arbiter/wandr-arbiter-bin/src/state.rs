...
//! [`Store`] (task 74 C1).
//!
//! The actual storage moved into `wandr-arbiter-core` so the responsibility
...
//! it move into `wandr-arbiter-shell` in C2, at which point this shim is deleted.
//!
...
pub use wandr_arbiter_core::{pid_alive, AppState};

use crate::core_store;

fn store() -> std::sync::MutexGuard<'static, wandr_arbiter_core::Store> {
